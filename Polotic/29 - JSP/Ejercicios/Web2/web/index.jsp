<%-- 
    Document   : index
    Created on : 08/12/2021, 18:43:43
    Author     : lucquifer
--%>
...
<html lang="en">
   <head>
      ...
      <!-- site metas -->public UsuarioJpaController() {
        emf = Persistence.createEntityManagerFactory("Web2_PU");
    }
      <title> cleaned</title>
                           ...
                           <div class="limit-box">
                              <nav class="main-menu">
                                 <ul class="menu-area-main">
                                    ...
                                    <li> <a href="empleados.jsp">Empleado</a> </li>
                                    <li> <a href="#clean">Usuario</a> </li>
